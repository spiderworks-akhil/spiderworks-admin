                            ...
                            <div class="col-md-6">
                                    <div class="row column-seperation padding-5">
                                        <div class="form-group form-group-default form-group-default-select2">
                                            ...
                                            <select name="category_id" class="full-width webadmin-select2-input" data-select2-url="{{route('spiderworks.webadmin.select2.categories', ['Blogs'])}}" data-placeholder="Select a Category">
                                                @if($obj->category)
