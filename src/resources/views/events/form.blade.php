...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="margin-bottom: 20px;" align="right">
            @if($obj->id)
                <span class="page-heading">EDIT EVENT</span>
            @else
                <span class="page-heading">CREATE NEW EVENT</span>
            @endif
            <div >
                <div class="btn-group">
                            ...
                            <div class="col-md-6">
                                    <div class="row column-seperation padding-5">
                                        <div class="form-group form-group-default form-group-default-select2">
                                            <label class="">Event Category</label>
                                            <select name="category_id" class="full-width webadmin-select2-input" data-select2-url="{{route('spiderworks.webadmin.select2.categories', ['Events'])}}" data-placeholder="Select a Category">
                                                @if($obj->category)
                                    ...
                                    <div class="form-group form-group-default">
                                        ...
                                        @php
                                            ...
                                            if($obj->start_time && $obj->end_time)
                                                $date_range = date('m/d/Y H:i', strtotime($obj->start_time)).' - '.date('m/d/Y H:i', strtotime($obj->end_time))
                                        @endphp
                                        <input type="text" name="date_time" class="form-control" value="{{$date_range}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="text" name="fees" class="form-control amount" value="{{$obj->fees}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default">
                                        ...
                                        <textarea name="location" class="form-control" rows="3" id="location">{{$obj->location}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
@section('bottom')
    <script type="text/javascript">
        ...
        $(function() {
          ...
          $('input[name="date_time"]').on('apply.daterangepicker', function(ev, picker) {
