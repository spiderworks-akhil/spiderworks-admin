    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-borderless padding-15">
                    <h6 class="box-title">@if($parent_data) Sub-category list of <b>{{$parent_data->name}}</b> &nbsp;&nbsp; <a href="{{ route($route.'.index', [$parent_data->parent_id]) }}" class="admin_sub_head_back">Back to Parent</a> @endif</h6>
                        <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                            ...
                            <tr>
                                ...
                                <th class="nosort nosearch table-width-10">Sub Categories</th>
                            ...
                            <tr>
                                ...
                                <th class="table-width-120 searchable-input">Type</th>
                                <th class="nosort nosearch table-width-10"></th>
                                <th class="nosort nosearch table-width-10"></th>
                                <th class="nosort nosearch table-width-10"></th>
                                <th class="nosort nosearch table-width-10"></th>
