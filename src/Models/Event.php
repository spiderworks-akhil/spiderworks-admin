...
class Event extends Model
{
    ...
    protected $fillable = array('slug', 'name', 'title', 'start_time', 'end_time', 'location', 'fees', 'short_description', 'content', 'parent_id', 'featured_image_id', 'banner_image_id', 'browser_title', 'meta_description', 'meta_keywords', 'top_description', 'bottom_description', 'og_title', 'og_description', 'og_image_id', 'extra_css', 'extra_js', 'faq_id', 'category_id', 'is_featured', 'status');
    ...
    protected function setRules() {
        ...
        $this->val_rules = array(
            ...
            'slug' => 'required|max:250|unique:events,slug,ignoreId',
            'content' => 'required',
        );
    }
